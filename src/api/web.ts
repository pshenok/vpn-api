...
import { registerLogger } from 'core/lib/interfaces/web/middlewares/logger';
import { registerErrorHandler } from 'core/lib/interfaces/web/middlewares/error-handler';
import { registerControllers } from 'core/lib/interfaces/web/plugins/controllers';
